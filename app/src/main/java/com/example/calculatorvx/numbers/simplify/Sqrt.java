...
import com.example.calculatorvx.MainFrame;
 ...
 * @since 2017-05- 16
 */
public class Sqrt extends UnaryExpression implements Expression {
    /**
    ...
    public double evaluate(Map<String, Double> assignment) throws Exception {
        return Math.sqrt(this.expression1.evaluate(assignment));
    }
    ...
    public String toString() {
        return "sqrt" + "(" + expression1.toString() + ")";
    }
    ...
    public Expression assign(String var, Expression expression) {
        return new Sqrt(this.expression1.assign(var, expression));
    }
    ...
    public Expression specificSimplify() {
        ...
        if (temp != null) {
            return new Num(Math.sqrt(temp));
        }
        return new Sqrt(this.expression1.simplify());
    }
