...
/**
 * This class features a Minus expression, using two expressions.
 *
 * @author Raz Shenkman
 * @version 1.0
 * @since 2017-05- 16
...
public class Minus extends BinaryExpression implements Expression {
     ...
     */
    public Minus(double val, Expression exp2) {
        this.expression1 = new Num(val);
        this.expression2 = exp2;
    }
     ...
     * @param val  number.
     */
    public Minus(Expression exp1, double val) {
        this.expression1 = exp1;
        this.expression2 = new Num(val);
    }
     ...
     * @param var  string.
     */
    public Minus(Expression exp1, String var) {
        this.expression1 = exp1;
        this.expression2 = new Var(var);
    }
     ...
     * @param exp2 expression.
     */
    public Minus(String var, Expression exp2) {
        this.expression1 = new Var(var);
        this.expression2 = exp2;
    }

    /**
     * This method evaluates the minus using a dictionary.
     *
    ...
    public Expression assign(String var, Expression expression) {
        return new Minus(this.expression1.assign(var, expression), this.expression2.assign(var, expression));
    }
    ...
    public Expression specificSimplify() {
        ...
        if (leftVal != null && rightVal != null) {
            if ((leftVal == 0.0 && rightVal == 0.0) || leftVal.doubleValue() == rightVal.doubleValue()) {
                return new Num(0);
            } else if (leftVal == 0 && rightVal != 0) {
                return new Neg(new Num(rightVal));
            } else if (leftVal != 0 && rightVal == 0) {
